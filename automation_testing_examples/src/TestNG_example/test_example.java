...
public class test_example {
	...
	public void loginPresent() {
		...
		boolean email = driver.findElement(By.name("reg_email__")).isDisplayed();
		boolean password = driver.findElement(By.name("reg_passwd__")).isDisplayed();
		Assert.assertTrue(email , "email found");
		Assert.assertTrue(password , "password found");
	}
